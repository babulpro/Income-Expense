...
const IncomePage =()=>{
    ...
    return(
        ...
        <div className="border w-2/3 mt-3 h-auto m-auto pb-10 mb-5 shadow-md py-1 px-3 bg-slate-600 rounded-md text-white capitalize">
            <h1 className="text-center  mt-5 rounded-sm bg-gradient-to-r from-yellow-600 via-yellow-900 to-yellow-700">Your Monthly Income Details</h1>
